...
import com.mall.admin.domain.vo.SmsFlashPromotionProduct;
...
public class SmsFlashPromotionProductRelationController {
    ...
    @ResponseBody
    public R<SmsFlashPromotionProductRelation> getItem(@PathVariable Long id) {
    ...
    @ResponseBody
    public R<Page<SmsFlashPromotionProduct>> list(@RequestParam(value = "flashPromotionId") Long flashPromotionId,
        ...
        return R.ok(Page.restPage(flashPromotionProductList));
    }
}
