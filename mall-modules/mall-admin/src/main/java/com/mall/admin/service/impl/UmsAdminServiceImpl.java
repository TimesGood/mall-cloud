...
import com.mall.core.api.ResultCode;
...
import com.mall.core.exception.Asserts;
...
public class UmsAdminServiceImpl implements UmsAdminService {
    ...
    public UmsAdmin register(UmsAdmin umsAdminParam) {
        ...
        //将密码进行加密操作
        String encodePassword = BCrypt.hashpw(umsAdmin.getPassword(),BCrypt.gensalt());
...
//        R restResult = authService.getAccessToken(params);
////        R restResult = authApi.getAccessToken(params);
//        if(HttpStatus.SUCCESS==restResult.getCode()&&restResult.getData()!=null){
...
//        return restResult;
    ...
    public int updatePassword(UpdateAdminPasswordParam param) {
        ...
        umsAdmin.setPassword(BCrypt.hashpw(param.getNewPassword(),BCrypt.gensalt()));
