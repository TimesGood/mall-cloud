...
public class CommonDAOInterfacePlugin extends PluginAdapter {
    ...
    /**
     * 为方法参数列表追加@Param("record") Model record, @Param("example") E example
     * @param method
     */
...
//        interface
    ...
    /**
     * 生成selectByExampleWithoutBLOBs方法
     */
    @Override
