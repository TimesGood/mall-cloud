package com.mall.gen.utils;

import cn.hutool.core.util.StrUtil;
import com.mall.gen.config.GenConfig;
import com.mall.gen.constant.GenConstants;
...
public class GenUtils {
    ...
    public static void initColumnField(GenTableColumn column, GenTable table) {
        ...
        if (arraysContains(GenConstants.COLUMNTYPE_STR, dataType) || arraysContains(GenConstants.COLUMNTYPE_TEXT, dataType)) {
            ...
            List<String> str = StrUtil.split(StrUtil.subBetween(column.getColumnType(), "(", ")"), StrUtil.COMMA);
    ...
    public static String getBusinessName(String tableName) {
        ...
        String businessName = StrUtil.sub(tableName, firstIndex + 1, nameLength);
        businessName = StrUtil.toCamelCase(businessName);
        return businessName;
    }
    ...
    public static String convertClassName(String tableName) {
        ...
        if (autoRemovePre && StrUtil.isNotEmpty(tablePrefix)) {
            List<String> searchList = StrUtil.split(tablePrefix, StrUtil.COMMA);
    ...
    public static String replaceFirst(String replacementm, List<String> searchList) {
        ...
        for (String searchString : searchList) {
            if (replacementm.startsWith(searchString)) {
                text = replacementm.replaceFirst(searchString, StrUtil.EMPTY);
                break;
            }
        }
        return text;
