package com.mall.gen.mbg;


import com.mall.gen.mbg.model.DatabaseConfig;
import com.mall.gen.mbg.model.DbType;
import com.mall.gen.mbg.model.GeneratorConfig;
import com.mall.gen.mbg.plugins.DbRemarksCommentGenerator;
import com.mall.gen.mbg.util.DbUtil;
...
//	    configuration.addClasspathEntry(connectorLibPath);
        ...
        if (generatorConfig.isOffsetLimit()) {
            if (DbType.MySQL.name().equals(dbType) || DbType.MySQL_8.name().equals(dbType)
                ...
                PluginConfiguration pluginConfiguration = new PluginConfiguration();
                pluginConfiguration.addProperty("type", "com.mall.gen.mbg.plugins.MySQLLimitPlugin");
                pluginConfiguration.setConfigurationType("com.mall.gen.mbg.plugins.MySQLLimitPlugin");
                context.addPluginConfiguration(pluginConfiguration);
            }
        }
        //for JSR310
        if (generatorConfig.isJsr310Support()) {
            ...
            javaTypeResolverConfiguration.setConfigurationType("com.mall.gen.mbg.plugins.JavaTypeResolverJsr310Impl");
        ...
        if(generatorConfig.isNeedForUpdate()) {
            if (DbType.MySQL.name().equals(dbType)
                    || DbType.PostgreSQL.name().equals(dbType)) {
                PluginConfiguration pluginConfiguration = new PluginConfiguration();
                pluginConfiguration.addProperty("type", "com.mall.gen.mbg.plugins.MySQLForUpdatePlugin");
                pluginConfiguration.setConfigurationType("com.mall.gen.mbg.plugins.MySQLForUpdatePlugin");
                context.addPluginConfiguration(pluginConfiguration);
            }
        }
        //repository 插件
        if(generatorConfig.isAnnotationDAO()) {
            if (DbType.MySQL.name().equals(dbType) || DbType.MySQL_8.name().equals(dbType)
                    || DbType.PostgreSQL.name().equals(dbType)) {
                PluginConfiguration pluginConfiguration = new PluginConfiguration();
                pluginConfiguration.addProperty("type", "com.mall.gen.mbg.plugins.RepositoryPlugin");
                pluginConfiguration.setConfigurationType("com.mall.gen.mbg.plugins.RepositoryPlugin");
                context.addPluginConfiguration(pluginConfiguration);
            }
        }
        if (generatorConfig.isUseDAOExtendStyle()) {
            if (DbType.MySQL.name().equals(dbType) || DbType.MySQL_8.name().equals(dbType)
				...
				pluginConfiguration.addProperty("type", "com.mall.gen.mbg.plugins.CommonDAOInterfacePlugin");
                pluginConfiguration.setConfigurationType("com.mall.gen.mbg.plugins.CommonDAOInterfacePlugin");
                context.addPluginConfiguration(pluginConfiguration);
            }
        }
